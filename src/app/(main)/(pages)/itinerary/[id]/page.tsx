          ...
          <div className="flex-1 max-w-4xl pr-2">
            ...
            <div className="py-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 p-6 border rounded-xl bg-white shadow-md max-w-4xl mx-auto mt-2">
                <FeatureItem icon="/images/iterate/min.png" label="Group Size" value={feature?.groupSize?.min} />
                <FeatureItem icon="/images/iterate/Days.png" label="Trip Duration" value={feature?.tripDuration} />
                <FeatureItem icon="/images/iterate/Moderate.png" label="Trip Difficulty" value={feature?.tripDifficulty} />
                <FeatureItem icon="/images/iterate/BreakFast.png" label="Meals" value={feature?.meals?.join(", ")} />
                <FeatureItem icon="/images/iterate/Trekking.png" label="Activities" value={feature?.activities?.join(", ")} />
                <FeatureItem icon="/images/iterate/Bed.png" label="Accommodation" value={feature?.accommodation?.join(" / ")} />
                <FeatureItem icon="/images/iterate/meters.png" label="Max Altitude" value={feature?.maxAltitude} />
                <FeatureItem icon="/images/iterate/Seasons.png" label="Best Season" value={feature?.bestSeason?.join(", ")} />
                <FeatureItem icon="/images/iterate/kathmandu.png" label="Start/End Point" value={feature?.startEndPoint} />
              </div>
            </div>
            ...
            <div className="py-6">
              <TextHeader text="Trek Map" align="left" size="large" width={855} />
            ...
            <div className="max-w-4xl py-6">
              <TextHeader text="Gallery" align="left" size="large" width={855} />
...
function FeatureItem({ icon, label, value }: { icon: string; label: string; value: any }) {
  return (
    <div className="flex items-center gap-4">
      <Image src={icon} alt={label} width={40} height={40} className="mt-1" />
      <div>
