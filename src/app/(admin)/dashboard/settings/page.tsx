  ...
  const renderTermsTab = () => (
    <section className="bg-white rounded-xl shadow-md border border-gray-200 w-full px-8 md:px-16 py-12">
      ...
      {termsLoading ? (
        ...
        <>
          <label htmlFor="termsContent" className="text-base font-semibold text-gray-700 mb-2 block">
            Please review and update the Terms & Conditions below. Ensure the language is formal and comprehensive.
          </label>
          <textarea
            id="termsContent"
            rows={12}
            ...
            placeholder="Enter the formal Terms & Conditions for your organization here. For example: 'These Terms and Conditions govern the use of this website and the services provided. By accessing or using the site, you agree to be bound by these terms...'"
            className="w-full mt-2 border border-gray-200 rounded-lg px-3 py-2 focus:ring-2 focus:ring-primary focus:border-primary outline-none text-base bg-white transition hover:bg-gray-50"
          />
