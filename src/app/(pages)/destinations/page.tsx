    ...
    return(
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
          ...
          <div className="lg:col-span-2">
            <ImageDisplay src={destinationdata[0].imageUrls[0]} variant="rectangle" width={840} height={430} title={destinationdata[0].title} />
          </div>

          {/* Square Image */}
          <div>
            <ImageDisplay src={destinationdata[1].imageUrls[1]} variant="square" title={destinationdata[1].title} />
          </div>
        </div>
