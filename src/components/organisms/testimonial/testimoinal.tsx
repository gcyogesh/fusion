...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ message, name, position, profileImage, rating }) => (
  <div className="flex flex-col w-[90vw] sm:w-[300px] md:w-[365px] lg:w-[360px] h-[250px] bg-[#FCE1AC] rounded-xl p-6 snap-center flex-shrink-0 shadow-md relative">
    ...
    <TextDescription text={message} className="w-full h-[150px] text-extrabold text-sm !text-[#1A1E21]" />
  ...
  ({ testimoinaldata }, ref) => {
    ...
    return (
      <div className="relative w-full max-w-6xl mx-auto px-4 py-10 overflow-hidden  z-0">
        ...
        <div className="relative w-full py-4  bg-[linear-gradient(90deg,_#FEF9EE_0.88%,_#1C9ADB_32.63%,_#0F7BBA_70.26%,_#FEF9EE_100%)] sm:bg-[linear-gradient(90deg,_#FEF9EE_0.88%,_#0F7BBA_50%,_#FEF9EE_100%)] md:bg-[linear-gradient(90deg,_#FEF9EE,_#1C9ADB,_#FEF9EE)]" ref={emblaRef}  style={{
          backgroundPosition: 'center',
          backgroundRepeat: 'no-repeat',
          backgroundSize: '60% 100%',
        }}>
          <div className="flex gap-5 px-3 py-2">
            {testimoinaldata.map((item, index) => (
